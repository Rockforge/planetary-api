...
app.config['MAIL_USERNAME'] = '5664b997643a59'
app.config['MAIL_PASSWORD'] = 'd4d4b21449797a'
...
def parameters():
    ...
    age = int(request.args.get('age')) # returns as string
    if age < 18:
...
@jwt_required # requires access_token
def add_planet():
...
def remove_planet(planet_id: int):
    ...
    if planet:
        ...
        return jsonify(message='That planet doest not exist'), 404
...
# Define the ability of serialize and deserialize single and collection
